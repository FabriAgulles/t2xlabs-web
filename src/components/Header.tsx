...
const Header = () => {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-space-black/80 backdrop-blur-md border-b border-neon-cyan/20">
        ...
        <div className="flex items-center">
          ...
          <div className="relative group">
            <img 
              ...
              alt="t2xLabs Logo" 
              className="h-10 w-auto animate-float group-hover:scale-110 transition-transform duration-300"
              onError={(e) => {
